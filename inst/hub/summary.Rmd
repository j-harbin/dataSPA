...
path <- "//dcnsbiona01a/BIODataSvc/IN/MSP/PowerBI-Projects/dataSPA/outputs/functionalGroup/"
links <- paste0("file:",path, gsub(" ", "%20", functional),".html")
