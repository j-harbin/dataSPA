...
if (!(unique(index$theme) == 0)) {
  cat("<u>Theme</u>: ", unique(index$theme))
  cat("  \n")
  cat("  \n")
}
if (!(unique(index$functional_group) == "")) {
  cat("<u>Functional Group</u>: ", unique(index$functional_group))
  cat("  \n")
  cat("  \n")
...
cat("<u>Division</u>: ", strsplit(index$section_display[1], " - ", fixed=TRUE)[[1]][3])
cat("  \n")
cat("  \n")
