...
res <- try(plotSPA(salary=index2, which="predictSalary", functionalGroup=functionalGroup[i], approved=approved), silent=TRUE)
...
if (run) {
res <- try(plotSPA(salary=research2, which="predictSalary", functionalGroup=unique(index2$functional_group), approved=approved), silent=TRUE)
}
```
...
```{r, echo=FALSE, fig.cap="Bar graph showing gap in funding (red) if funding stayed the same and salary cost continued to increase. The rate of increase is determined using linear regression. Actual years are shown on the left of the dashed line, and predicted years are on the right of the dashed line. Total gap amount rounded to the nearest dollar shown in red text."}
if (runm) {
res <- try(plotSPA(salary=monitor2, which="predictSalary", functionalGroup=unique(index2$functional_group), approved=approved), silent=TRUE)
}
```
...
```{r, echo=FALSE, fig.cap="Bar graph showing gap in funding (red) if funding stayed the same and salary cost continued to increase. The rate of increase is determined using linear regression. Actual years are shown on the left of the dashed line, and predicted years are on the right of the dashed line. Total gap amount rounded to the nearest dollar shown in red text."}
if (run) {
res <- try(plotSPA(salary=assessment2, which="predictSalary", functionalGroup=unique(index2$functional_group), approved=approved), silent=TRUE)
}
```
...
```{r, echo=FALSE, fig.cap="Bar graph showing gap in funding (red) if funding stayed the same and salary cost continued to increase. The rate of increase is determined using linear regression. Actual years are shown on the left of the dashed line, and predicted years are on the right of the dashed line. Total gap amount rounded to the nearest dollar shown in red text."}
if (run) {
res <- try(plotSPA(salary=management2, which="predictSalary", functionalGroup=unique(index2$functional_group), approved=approved), silent=TRUE)
}
```
...
```{r, echo=FALSE, fig.cap="Bar graph showing gap in funding (red) if funding stayed the same and salary cost continued to increase. The rate of increase is determined using linear regression. Actual years are shown on the left of the dashed line, and predicted years are on the right of the dashed line. Total gap amount rounded to the nearest dollar shown in red text."}
if (run) {
res <- try(plotSPA(salary=other2, which="predictSalary", functionalGroup=unique(index2$functional_group), approved=approved), silent=TRUE)
}
```
