...
df <- plotSPA(om=index, which="omAllocation", functionalGroup =unique(index$functional_group), dataframe = TRUE)
headers <- names(df)
...
```{r, results="asis", echo=FALSE}
df <- try(plotSPA(salary=index2, which="salaryAllocation", functionalGroup=unique(index2$functiona_group), dataframe = TRUE), silent=TRUE)
...
```{r, results="asis", echo=FALSE}
if (run) {
df <- plotSPA(om=research1, which="omAllocation", functionalGroup=unique(index$functional_group), dataframe = TRUE)
headers <- names(df)
for (j in seq_along(headers)) {
     cat("#### ", headers[j], "\n\n",
         knitr::knit_child("plot.Rmd", quiet = TRUE), "\n\n")
...
```{r, results="asis", echo=FALSE}
if (run) {
df <- plotSPA(om=monitor1, which="omAllocation", functionalGroup=unique(index$functional_group), dataframe = TRUE)
headers <- names(df)
for (j in seq_along(headers)) {
     cat("#### ", headers[j], "\n\n",
         knitr::knit_child("plot.Rmd", quiet = TRUE), "\n\n")
...
```{r, results="asis", echo=FALSE}
if (run) {
df <- plotSPA(om=assessment1, which="omAllocation", functionalGroup=unique(index$functional_group), dataframe = TRUE)
headers <- names(df)
for (j in seq_along(headers)) {
     cat("#### ", headers[j], "\n\n",
         knitr::knit_child("plot.Rmd", quiet = TRUE), "\n\n")
...
```{r, results="asis", echo=FALSE}
if (run) {
df <- plotSPA(om=management1, which="omAllocation", functionalGroup=unique(index$functional_group), dataframe = TRUE)
headers <- names(df)
for (j in seq_along(headers)) {
     cat("#### ", headers[j], "\n\n",
         knitr::knit_child("plot.Rmd", quiet = TRUE), "\n\n")
...
```{r, results="asis", echo=FALSE}
if (run) {
df <- plotSPA(om=other1, which="omAllocation", functionalGroup=unique(index$functional_group), dataframe = TRUE)
headers <- names(df)
for (j in seq_along(headers)) {
     cat("#### ", headers[j], "\n\n",
         knitr::knit_child("plot.Rmd", quiet = TRUE), "\n\n")
