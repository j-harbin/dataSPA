...
plotSPA(om=index, functionalGroup=unique(index$functional_group), which="omBar")
```
...
plotSPA(om=index,which="predictOM", functionalGroup=functionalGroup[i])
```
...
plotSPA(salary=index2, functionalGroup=unique(index2$functional_group), which="salaryBar")
```
...
plotSPA(om=research1, functionalGroup=unique(index$functional_group), which="omBar")
} else {
...
```{r, echo=FALSE, fig.cap="Bar graph showing gap in funding (red) if funding stayed the same and O&M increased by 2%. Actual years are shown on the left of the dashed line, and predicted years are on the right of the dashed line. Total gap amount rounded to the nearest dollar shown in red text."}
if (run) {
plotSPA(om=research1,which="predictOM", functionalGroup=functionalGroup[i])
}
```
...
plotSPA(om=monitor1, functionalGroup=unique(index$functional_group), which="omBar")
} else {
...
```{r, echo=FALSE, fig.cap="Bar graph showing gap in funding (red) if funding stayed the same and O&M increased by 2%. Actual years are shown on the left of the dashed line, and predicted years are on the right of the dashed line. Total gap amount rounded to the nearest dollar shown in red text."}
if (run) {
plotSPA(om=monitor1,which="predictOM", functionalGroup=functionalGroup[i])
}
```
...
plotSPA(om=assessment1, functionalGroup=unique(index$functional_group), which="omBar")
} else {
...
```{r, echo=FALSE, fig.cap="Bar graph showing gap in funding (red) if funding stayed the same and O&M increased by 2%. Actual years are shown on the left of the dashed line, and predicted years are on the right of the dashed line. Total gap amount rounded to the nearest dollar shown in red text."}
if (run) {
plotSPA(om=assessment1,which="predictOM", functionalGroup=functionalGroup[i])
}
```
...
plotSPA(om=management1, functionalGroup=unique(index$functional_group), which="omBar")
} else {
...
if (run) {
plotSPA(om=management1,which="predictOM", functionalGroup=functionalGroup[i])
}
```
...
plotSPA(om=other1, functionalGroup=unique(index$functional_group), which="omBar")
} else {
...
```{r, echo=FALSE, fig.cap="Bar graph showing gap in funding (red) if funding stayed the same and O&M increased by 2%. Actual years are shown on the left of the dashed line, and predicted years are on the right of the dashed line. Total gap amount rounded to the nearest dollar shown in red text."}
if (run) {
plotSPA(om=other1,which="predictOM", functionalGroup=functionalGroup[i])
}
```
