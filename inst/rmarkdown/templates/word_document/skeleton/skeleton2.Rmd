...
plotSPA(salary=research2, theme=unique(index2$theme), which="salaryBar")
```
...
```{r, results="asis", echo=FALSE}
df <- plotSPA(salary=research2, which="salaryAllocation", theme=unique(research2$theme), dataframe = TRUE)
...
plotSPA(salary=monitor2, theme=unique(index2$theme), which="salaryBar")
```
...
```{r, results="asis", echo=FALSE}
df <- plotSPA(salary=monitor2, which="salaryAllocation", theme=unique(monitor2$theme), dataframe = TRUE)
...
plotSPA(om=monitor2, salary=monitor2, which="predictSalary", theme=unique(index2$theme))
```
