...
plotSPA(om=index, theme=theme, which="omBar")
```
...
plotSPA(salary=index2, theme=theme, which="salaryBar")
```
...
plotSPA(om=index, salary=index2, which="predictSalary", theme=theme)
